      ...
      <div className="mt-12 grid w-full gap-5 md:grid-cols-3">
        {steps.map((s) => {
          ...
          return (
            <div
              key={s.step}
              className="relative rounded-2xl border border-line bg-white p-7 transition-all hover:-translate-y-1 hover:shadow-lg hover:shadow-brand-100/50"
            >
              <span className="absolute right-6 top-6 font-display text-4xl font-bold text-brand-50">
                {s.step}
              </span>
              <div className="mb-5 inline-flex size-12 items-center justify-center rounded-xl bg-brand-50 text-brand-600">
