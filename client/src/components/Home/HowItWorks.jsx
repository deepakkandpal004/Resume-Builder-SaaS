...
const steps = [
  ...
  },
  {
    ...
    description:
      "Choose from 7 professional templates and personalize it with your own accent color in real time.",
  },
  {
    icon: Download,
    step: "03",
...
const HowItWorks = () => {
  ...
  return (
    ...
    >
      ...
      <div className="reveal mt-12 grid w-full gap-5 md:grid-cols-3">
        {steps.map((s, i) => {
          const Icon = s.icon;
          return (
            <div
              key={s.step}
            className="reveal relative rounded-2xl border border-line bg-surface p-7 transition-all hover:-translate-y-1 hover:shadow-lg hover:shadow-brand-100/50 dark:hover:shadow-black/20"
