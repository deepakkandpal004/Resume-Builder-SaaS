        ...
        <div className="max-w-4xl mx-auto p-10 bg-white text-gray-800 leading-relaxed">
            ...
            {data.professional_summary && (
                <section className="mb-6">
                    <h2 className="font-resume text-lg font-semibold tracking-wide mb-3" style={{ color: accentColor }}>
                        PROFESSIONAL SUMMARY
                    </h2>
            ...
            {data.experience && data.experience.length > 0 && (
                <section className="mb-6">
                    <h2 className="font-resume text-lg font-semibold tracking-wide mb-4" style={{ color: accentColor }}>
