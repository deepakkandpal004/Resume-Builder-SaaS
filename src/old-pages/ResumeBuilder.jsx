...
import { resetAts } from "@/lib/store/features/atsSlice";
import { resetCoverLetter } from "@/lib/store/features/coverLetterSlice";
import { resetTailor } from "@/lib/store/features/tailorSlice";
import { resetInterview } from "@/lib/store/features/interviewSlice";
      ...
      <header className="sticky top-0 z-40 bg-surface border-b border-line shadow-sm shrink-0 h-16 flex items-center px-4 lg:px-6">
        <div className="w-full flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 min-w-0">
            <Link href="/app" className="flex items-center justify-center p-1.5 rounded-lg hover:bg-canvas text-muted hover:text-brand-600 transition-colors shrink-0" title="Back to Dashboard">
